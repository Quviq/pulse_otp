...
trans_init(gen,init_it,[pulse_gen_server,_,_,supervisor,{_,Module,_},_]) ->
    {supervisor,Module,1};
trans_init(gen,init_it,[pulse_gen_server,_,_,_,supervisor,{_,Module,_},_]) ->
    {supervisor,Module,1};
trans_init(gen,init_it,[pulse_gen_server,_,_,supervisor_bridge,[Module|_],_]) ->
    {supervisor_bridge,Module,1};
trans_init(gen,init_it,[pulse_gen_server,_,_,_,supervisor_bridge,[Module|_],_]) ->
    {supervisor_bridge,Module,1};
trans_init(gen,init_it,[pulse_gen_server,_,_,Module,_,_]) ->
    {Module,init,1};
trans_init(gen,init_it,[pulse_gen_server,_,_,_,Module|_]) ->
    {Module,init,1};
trans_init(gen,init_it,[pulse_gen_fsm,_,_,Module,_,_]) ->
    {Module,init,1};
trans_init(gen,init_it,[pulse_gen_fsm,_,_,_,Module|_]) ->
    {Module,init,1};
trans_init(gen,init_it,[pulse_gen_event|_]) ->
    {pulse_gen_event,init_it,6};
